    ...
    <div class="col-md-12"> 
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Register a new student(should be new to the system)') }}</div>
        
                        <div class="card-body">
                            <form method="POST" action="{{ route('regnewstudent') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ old('surname') }}" required autocomplete="firstname" autofocus>
